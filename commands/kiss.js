...
module.exports.run = (bot, message, args, database, member) => {
    ...
    const exemfEmbed = new Discord.MessageEmbed()
        .setColor('#ffc0cb')
        .setAuthor(`${message.author.tag} is biting ${member1.user.tag} !`)
