...
module.exports.run = (bot, message, args, database, member) => {
    ...
    const exemtEmbed = new Discord.MessageEmbed()
        .setColor('#ffc0cb')
        .setAuthor(`${message.author.tag} падает со смеху!`)
